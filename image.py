...
under_game_score_y = 296     # 截图中刚好低于分数显示区域的 Y 坐标，300 是 1920x1080 的值，2K 屏、全面屏请根据实际情况修改
...
piece_base_height_1_2 = 70   # 二分之一的棋子底座高度，可能要调节
...
def main():
    while True:
        ...
        time.sleep(random.uniform(8, 15))   # 为了保证截图的时候应落稳了，多延迟一会儿
